...
enterAsPatient.addEventListener('click', function(ev){
	...
	myUserType = 						"patient"; // Enter as patient add user type
...
requestDoctor.addEventListener('click', function(ev){
	...
	myName = patientUserName; // Add own name
	io.emit('signal', {
		"user_type": "patient", 
...
enterAsDoctor.addEventListener('click', function(ev){
	...
	myUserType = 						"doctor"; // Enter as doctor add user type
...
doctorSignupButton.addEventListener('click', function(ev){
	...
	myName = doctorUserName; // Add own name
	io.emit('signal', {
		"user_type": "doctor", 
